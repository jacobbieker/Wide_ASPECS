...
franco_catalog = np.nan_to_num(franco_catalog)



# Now stellar mass distribution
spec_mass_star, spec_mass_star_error = create_points_and_error("Mstar", full_catalog)
franco_mass_star, franco_mass_star_error = create_points_and_error("Mstar", franco_catalog)
...
plt.hist(franco_mass_star, label='Franco et al.', histtype='step')
...
franco_sfr, franco_sfr_error = create_points_and_error("SFR", franco_catalog)
plt.scatter(mass_star, sfr, s=2, color='lightgrey')
plt.scatter(spec_mass_star, spec_sfr, s=2, color='black')
plt.scatter(franco_mass_star, franco_sfr, s=3, color='red', marker='star')
