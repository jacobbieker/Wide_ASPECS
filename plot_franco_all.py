...
franco_catalog = fits.open("/home/jacob/Research/MAGPHYS/No11mm/catalog.fits")
...
ax1.errorbar(low_z_mass, low_z_sfr, yerr=low_z_sfr_error, xerr=low_z_mass_error, ecolor='lightgrey', fmt='.', ms=1, mec='pink', elinewidth=1)
ax1.plot(np.unique(low_z_mass), np.poly1d(np.polyfit(low_z_mass, low_z_sfr, 1))(np.unique(low_z_mass)), label= 'All fit', color='r', zorder=10)
ax1.set_title('0 < Z < 1')
ax2.errorbar(mid_z_mass, mid_z_sfr, yerr=mid_z_sfr_error, xerr=mid_z_mass_error, ecolor='lightgrey', fmt='.', ms=1, mec='blue', elinewidth=1)
ax2.plot(np.unique(mid_z_mass), np.poly1d(np.polyfit(mid_z_mass, mid_z_sfr, 1))(np.unique(mid_z_mass)), color='r', zorder=10)
ax2.set_title('1 < Z < 2')
ax3.errorbar(high_z_mass, high_z_sfr, yerr=high_z_sfr_error, xerr=high_z_mass_error, ecolor='lightgrey', fmt='.', ms=1, mec='green', elinewidth=1)
ax3.plot(np.unique(high_z_mass), np.poly1d(np.polyfit(high_z_mass, high_z_sfr, 1))(np.unique(high_z_mass)), color='r', zorder=10)
ax3.set_title('2 < Z < 3')
ax4.errorbar(vhigh_z_mass, vhigh_z_sfr, yerr=vhigh_z_sfr_error, xerr=vhigh_z_mass_error, ecolor='lightgrey', fmt='.', ms=1, mec='orange', elinewidth=1)
ax4.plot(np.unique(vhigh_z_mass), np.poly1d(np.polyfit(vhigh_z_mass, vhigh_z_sfr, 1))(np.unique(vhigh_z_mass)), color='r', zorder=10)
...
f, ((ax1, ax2), (ax3, ax4)) = plt.subplots(2, 2, sharex='all', sharey='all')
ax1.errorbar(low_z_mass, low_z_sfr, yerr=low_z_sfr_error, xerr=low_z_mass_error, ecolor='lightgrey', fmt='.', ms=1, mec='lightgrey', elinewidth=1, zorder=-32)
ax1.plot(np.unique(low_z_mass), np.poly1d(np.polyfit(low_z_mass, low_z_sfr, 1))(np.unique(low_z_mass)), label= 'All fit', color='red')
ax1.scatter(spec_low_z_mass, spec_low_z_sfr, color='yellow', label='Spec', s=1)
ax1.plot(np.unique(spec_low_z_mass), np.poly1d(np.polyfit(spec_low_z_mass, spec_low_z_sfr, 1))(np.unique(spec_low_z_mass)), label='Spec Fit', color='b')
ax1.scatter(rob_low_z_mass, rob_low_z_sfr, color='black', marker='s', label='Roberto', s=1)
ax1.plot(np.unique(rob_low_z_mass), np.poly1d(np.polyfit(rob_low_z_mass, rob_low_z_sfr, 1))(np.unique(rob_low_z_mass)), label='Roberto Fit', color='green')
#ax1.scatter(franco_low_z_mass, franco_low_z_sfr, color='yellow1, marker='*', s=8)
ax1.set_title('0 < Z < 1')
ax2.errorbar(mid_z_mass, mid_z_sfr, yerr=mid_z_sfr_error, xerr=mid_z_mass_error, ecolor='lightgrey', fmt='.', ms=1, mec='lightgrey', elinewidth=1, zorder=-32)
...
ax2.plot(np.unique(spec_mid_z_mass), np.poly1d(np.polyfit(spec_mid_z_mass, spec_mid_z_sfr, 1))(np.unique(spec_mid_z_mass)), color='b')
ax2.scatter(rob_mid_z_mass, rob_mid_z_sfr, color='black', marker='s', s=1)
ax2.plot(np.unique(rob_mid_z_mass), np.poly1d(np.polyfit(rob_mid_z_mass, rob_mid_z_sfr, 1))(np.unique(rob_mid_z_mass)), color='green')
#ax2.scatter(franco_mid_z_mass, franco_mid_z_sfr, color='yellow1, marker='*', s=8)
ax2.set_title('1 < Z < 2')
ax3.errorbar(high_z_mass, high_z_sfr, yerr=high_z_sfr_error, xerr=high_z_mass_error, ecolor='lightgrey', fmt='.', ms=1, mec='lightgrey', elinewidth=1, zorder=-32)
...
ax3.plot(np.unique(spec_high_z_mass), np.poly1d(np.polyfit(spec_high_z_mass, spec_high_z_sfr, 1))(np.unique(spec_high_z_mass)), color='b')
ax3.scatter(rob_high_z_mass, rob_high_z_sfr, color='black', marker='s', s=1)
ax3.plot(np.unique(rob_high_z_mass), np.poly1d(np.polyfit(rob_high_z_mass, rob_high_z_sfr, 1))(np.unique(rob_high_z_mass)), color='green')
#ax3.scatter(franco_high_z_mass, franco_high_z_sfr, color='yellow1, marker='*', s=8)
ax3.set_title('2 < Z < 3')
ax4.errorbar(vhigh_z_mass, vhigh_z_sfr, yerr=vhigh_z_sfr_error, xerr=vhigh_z_mass_error, ecolor='lightgrey', fmt='.', ms=1, mec='lightgrey', elinewidth=1, zorder=-32)
ax4.plot(np.unique(vhigh_z_mass), np.poly1d(np.polyfit(vhigh_z_mass, vhigh_z_sfr, 1))(np.unique(vhigh_z_mass)), color='red')
ax4.scatter(spec_vhigh_z_mass, spec_vhigh_z_sfr, color='yellow', s=1)
ax4.plot(np.unique(spec_vhigh_z_mass), np.poly1d(np.polyfit(spec_vhigh_z_mass, spec_vhigh_z_sfr, 1))(np.unique(spec_vhigh_z_mass)), color='b')
ax4.scatter(rob_vhigh_z_mass, rob_vhigh_z_sfr, color='black', marker='s', s=1)
ax4.plot(np.unique(rob_vhigh_z_mass), np.poly1d(np.polyfit(rob_vhigh_z_mass, rob_vhigh_z_sfr, 1))(np.unique(rob_vhigh_z_mass)), color='green')
...
plt.errorbar(mass, sfr, yerr=sfr_error, xerr=mass_error, ecolor='lightgrey', fmt='.', mec='lightgrey', ms=1, label='All', elinewidth=1, zorder=-32)
...
plt.plot(np.unique(rob_mass), np.poly1d(np.polyfit(rob_mass, rob_sfr, 1))(np.unique(rob_mass)), color='green', label='Roberto fit')
plt.plot(np.unique(spec_mass), np.poly1d(np.polyfit(spec_mass, spec_sfr, 1))(np.unique(spec_mass)), color='blue', label='Spec Fit')
plt.legend(loc='best')
plt.ylabel('Log(SFR)')
...
plt.errorbar(spec_mass, spec_sfr, yerr=spec_sfr_error, xerr=spec_mass_error, ecolor='lightgrey', fmt='.', mec='yellow', ms=1, label='Spectroscopic', elinewidth=1, zorder=-32)
plt.scatter(rob_mass, rob_sfr, color='black', label='Roberto', s=1)
plt.plot(np.unique(mass), np.poly1d(np.polyfit(mass, sfr, 1))(np.unique(mass)), color='red', label='All Fit')
#plt.plot(np.unique(rob_mass), np.poly1d(np.polyfit(rob_mass, rob_sfr, 1))(np.unique(rob_mass)), color='yellow1)
plt.plot(np.unique(spec_mass), np.poly1d(np.polyfit(spec_mass, spec_sfr, 1))(np.unique(spec_mass)), color='black', label='Spec Fit')
plt.legend(loc='best')
plt.ylabel('Log(SFR)')
plt.xlabel('Log(M*) [Msun]')
plt.title('M* vs SFR')
...
plt.errorbar(mass, ssfr, yerr=ssfr_error, xerr=mass_error, ecolor='lightgrey', fmt='.', mec='lightblue', ms=1, label='All', elinewidth=1, zorder=-32)
...
f, ((ax1, ax2), (ax3, ax4)) = plt.subplots(2, 2, sharex='all', sharey='all')
ax1.errorbar(low_z_mass, low_z_ssfr, yerr=low_z_ssfr_error, xerr=low_z_mass_error, ecolor='lightgrey', fmt='.', ms=1, mec='pink', elinewidth=1)
ax1.plot(np.unique(low_z_mass), np.poly1d(np.polyfit(low_z_mass, low_z_ssfr, 1))(np.unique(low_z_mass)), label= 'All fit', color='r', zorder=10)
ax1.set_title('0 < Z < 1')
ax2.errorbar(mid_z_mass, mid_z_ssfr, yerr=mid_z_ssfr_error, xerr=mid_z_mass_error, ecolor='lightgrey', fmt='.', ms=1, mec='blue', elinewidth=1)
ax2.plot(np.unique(mid_z_mass), np.poly1d(np.polyfit(mid_z_mass, mid_z_ssfr, 1))(np.unique(mid_z_mass)), color='r', zorder=10)
ax2.set_title('1 < Z < 2')
ax3.errorbar(high_z_mass, high_z_ssfr, yerr=high_z_ssfr_error, xerr=high_z_mass_error, ecolor='lightgrey', fmt='.', ms=1, mec='green', elinewidth=1)
ax3.plot(np.unique(high_z_mass), np.poly1d(np.polyfit(high_z_mass, high_z_ssfr, 1))(np.unique(high_z_mass)), color='r', zorder=10)
ax3.set_title('2 < Z < 3')
ax4.errorbar(vhigh_z_mass, vhigh_z_ssfr, yerr=vhigh_z_ssfr_error, xerr=vhigh_z_mass_error, ecolor='lightgrey', fmt='.', ms=1, mec='orange', elinewidth=1)
ax4.plot(np.unique(vhigh_z_mass), np.poly1d(np.polyfit(vhigh_z_mass, vhigh_z_ssfr, 1))(np.unique(vhigh_z_mass)), color='r', zorder=10)
ax4.set_title('3 < Z < 4')
handles, labels = ax1.get_legend_handles_labels()
f.legend(loc='best', handles=handles, labels=labels, prop={'size': 6})
f.text(0.5, 0.01, 'Log Stellar Mass (Mstar)', ha='center')
...
ax1.errorbar(low_z_mass, low_z_ssfr, yerr=low_z_ssfr_error, xerr=low_z_mass_error, ecolor='lightgrey', fmt='.', ms=1, mec='black', label='Roberto', elinewidth=1)
ax1.plot(np.unique(low_z_mass), np.poly1d(np.polyfit(low_z_mass, low_z_ssfr, 1))(np.unique(rob_low_z_mass)), label= 'Roberto fit', color='g', zorder=10)
ax1.set_title('0 < Z < 1')
ax2.errorbar(mid_z_mass, mid_z_ssfr, yerr=mid_z_ssfr_error, xerr=mid_z_mass_error, ecolor='lightgrey', fmt='.', ms=1, mec='black', elinewidth=1)
ax2.plot(np.unique(mid_z_mass), np.poly1d(np.polyfit(mid_z_mass, mid_z_ssfr, 1))(np.unique(mid_z_mass)), color='g', zorder=10)
ax2.set_title('1 < Z < 2')
ax3.errorbar(high_z_mass, high_z_ssfr, yerr=high_z_ssfr_error, xerr=high_z_mass_error, ecolor='lightgrey', fmt='.', ms=1, mec='black', elinewidth=1)
ax3.plot(np.unique(high_z_mass), np.poly1d(np.polyfit(high_z_mass, high_z_ssfr, 1))(np.unique(high_z_mass)), color='g', zorder=10)
ax3.set_title('2 < Z < 3')
ax4.errorbar(vhigh_z_mass, vhigh_z_ssfr, yerr=vhigh_z_ssfr_error, xerr=vhigh_z_mass_error, ecolor='lightgrey', fmt='.', ms=1, mec='black', elinewidth=1)
ax4.plot(np.unique(vhigh_z_mass), np.poly1d(np.polyfit(vhigh_z_mass, vhigh_z_ssfr, 1))(np.unique(vhigh_z_mass)), color='g', zorder=10)
ax4.set_title('3 < Z < 4')
...
ax1.errorbar(low_z_mass, low_z_ssfr, yerr=low_z_ssfr_error, xerr=low_z_mass_error, ecolor='lightgrey', fmt='.', ms=1, mec='yellow', label='Spec', elinewidth=1)
ax1.plot(np.unique(low_z_mass), np.poly1d(np.polyfit(low_z_mass, low_z_ssfr, 1))(np.unique(low_z_mass)), label= 'Spec fit', color='b', zorder=10)
ax1.set_title('0 < Z < 1')
ax2.errorbar(mid_z_mass, mid_z_ssfr, yerr=mid_z_ssfr_error, xerr=mid_z_mass_error, ecolor='lightgrey', fmt='.', ms=1, mec='yellow', elinewidth=1)
ax2.plot(np.unique(mid_z_mass), np.poly1d(np.polyfit(mid_z_mass, mid_z_ssfr, 1))(np.unique(mid_z_mass)), color='b', zorder=10)
ax2.set_title('1 < Z < 2')
ax3.errorbar(high_z_mass, high_z_ssfr, yerr=high_z_ssfr_error, xerr=high_z_mass_error, ecolor='lightgrey', fmt='.', ms=1, mec='yellow', elinewidth=1)
ax3.plot(np.unique(high_z_mass), np.poly1d(np.polyfit(high_z_mass, high_z_ssfr, 1))(np.unique(high_z_mass)), color='b', zorder=10)
ax3.set_title('2 < Z < 3')
ax4.errorbar(vhigh_z_mass, vhigh_z_ssfr, yerr=vhigh_z_ssfr_error, xerr=vhigh_z_mass_error, ecolor='lightgrey', fmt='.', ms=1, mec='yellow', elinewidth=1)
ax4.plot(np.unique(vhigh_z_mass), np.poly1d(np.polyfit(vhigh_z_mass, vhigh_z_ssfr, 1))(np.unique(vhigh_z_mass)), color='b', zorder=10)
ax4.set_title('3 < Z < 4')
...
f, ((ax1, ax2), (ax3, ax4)) = plt.subplots(2, 2, sharex='all', sharey='all')
ax1.errorbar(low_z_mass, low_z_ssfr, yerr=low_z_ssfr_error, xerr=low_z_mass_error, ecolor='lightgrey', fmt='.', ms=1, mec='pink', label='Roberto', elinewidth=1)
ax1.plot(np.unique(low_z_mass), np.poly1d(np.polyfit(low_z_mass, low_z_ssfr, 1))(np.unique(rob_low_z_mass)), label= 'Roberto fit', color='r', zorder=10)
ax1.set_title('0 < Z < 1')
ax2.errorbar(mid_z_mass, mid_z_ssfr, yerr=mid_z_ssfr_error, xerr=mid_z_mass_error, ecolor='lightgrey', fmt='.', ms=1, mec='blue', elinewidth=1)
ax2.plot(np.unique(mid_z_mass), np.poly1d(np.polyfit(mid_z_mass, mid_z_ssfr, 1))(np.unique(mid_z_mass)), color='r', zorder=10)
ax2.set_title('1 < Z < 2')
...
f, ((ax1, ax2), (ax3, ax4)) = plt.subplots(2, 2, sharex='all', sharey='all')
ax1.errorbar(low_z_mass, low_z_ssfr, yerr=low_z_ssfr_error, xerr=low_z_mass_error, ecolor='lightgrey', fmt='.', ms=1, mec='pink', label='Spec', elinewidth=1)
ax1.plot(np.unique(low_z_mass), np.poly1d(np.polyfit(low_z_mass, low_z_ssfr, 1))(np.unique(low_z_mass)), label= 'Spec fit', color='r', zorder=10)
ax1.set_title('0 < Z < 1')
ax2.errorbar(mid_z_mass, mid_z_ssfr, yerr=mid_z_ssfr_error, xerr=mid_z_mass_error, ecolor='lightgrey', fmt='.', ms=1, mec='blue', elinewidth=1)
ax2.plot(np.unique(mid_z_mass), np.poly1d(np.polyfit(mid_z_mass, mid_z_ssfr, 1))(np.unique(mid_z_mass)), color='r', zorder=10)
ax2.set_title('1 < Z < 2')
