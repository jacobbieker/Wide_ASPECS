...
for option_name in ["all_closest", "all", "closest"]:
    for separation in [1.5]:
        for snrlimit in [6.0,5.9,5.8]:
            ...
            ascii.write(aspecs_table, "ASPECS_Line_Candidates_{}_Sep_{}_SN_{}.txt".format(option_name, separation, snrlimit), format='fixed_width', bookend=False, delimiter=None, formats={'RA (J2000)': '', 'DEC (J2000)': '%2.6f', 'Roberto RA': '%2.6f', 'Roberto DEC': '%2.6f','Observed CO (GHz)': '%3.4f', 'Restframe CO (GHz)': '%3.4f', 'Z (CO)': '%2.3f', 'Z (Matched)': '%2.3f',
