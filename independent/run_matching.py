...
for option_name in ["all_closest"]:
    for separation in [1.5, 1.0]:
        for snrlimit in [10., 9.5, 9.0, 8.5, 8.0, 7.5, 7.0]:
            ...
            plot_mstar_vs_sfr(aspecs_catalog, combined_catalog, snr_limit=snrlimit, filename="Mstar_vs_SFR_{}_sep_{}_sn_{}.png".format(option_name, separation, snrlimit))
            aspecs_table, aspecs_catalog = match_lines_to_catalog(aspecs_lines, combined_catalog, method=option_name, max_sep=separation, snr_limit=snrlimit, max_redshift=0.3)
            ...
            plot_mstar_vs_sfr(aspecs_catalog, combined_catalog, snr_limit=snrlimit, filename="Mstar_vs_SFR_cleaned_{}_sep_{}_sn_{}.png".format(option_name, separation, snrlimit))
