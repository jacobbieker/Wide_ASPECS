...
def build_catalog():
    ...
    One_One_mm = [1.99, 2.13, 2.19, 1.69, 1.40, 1.26, 1.20, 1.98, 1.39, 1.04, 1.58, 1.13, 0.47, 1.17, 0.64, 0.99, 1.37, 0.79, 0.72, 1.18, 0.88, 1.26, 1.05]
    One_one_err = [0.15, 0.15, 0.15, 0.18, 0.18, 0.16, 0.13, 0.20, 0.17, 0.13, 0.22, 0.15, 0.14, 0.15, 0.15, 0.17, 0.18, 0.15, 0.13, 0.23, 0.19, 0.22, 0.20]
